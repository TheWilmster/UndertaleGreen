...
if (curr_menu == 3 || curr_menu == 4)
{
	if (act0_save1data == 1)
	{
		var dataToLoad = jsonLoad("act0_file1");
		act0_1location = dataToLoad.last_location;
		act0_1minutes = floor(dataToLoad.last_save_time / 1800);
		act0_1seconds = floor((dataToLoad.last_save_time - (act0_1minutes * 1800)) / 30);
	...
	if (act0_save2data == 1)
	{
		var dataToLoad = jsonLoad("act0_file2");
		act0_2location = dataToLoad.last_location;
		act0_2minutes = floor(dataToLoad.last_save_time / 1800);
		act0_2seconds = floor((dataToLoad.last_save_time - (act0_2minutes * 1800)) / 30);
	...
	if (act0_save3data == 1)
	{
		var dataToLoad = jsonLoad("act0_file3");
		act0_3location = dataToLoad.last_location;
		act0_3minutes = floor(dataToLoad.last_save_time / 1800);
		act0_3seconds = floor((dataToLoad.last_save_time - (act0_3minutes * 1800)) / 30);
