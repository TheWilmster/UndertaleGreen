...
face_image = -1;
face_x = 0;
if (obj_player.y > (room_height - 120) && !instance_exists(obj_end_credits))
	txt_y = -312;
else
	txt_y = 0;
if (room == rm_forest_bench_post)
	txt_y = -312;
if (room == rm_ebott_ff)
	txt_y = 0;
if (instance_exists(obj_chai_forest_bench))
{
	if (obj_chai_forest_bench.book_cutscene == 1)
		txt_y = 0;
}
...
scribble_typists_add_event("teleopen", function(arg0, arg1, arg2)
{
	obj_telescope.tele_open = true;
});
...
scribble_typists_add_event("royslide", function(arg0, arg1, arg2)
{
	obj_jim.royslide = true;
});
scribble_typists_add_event("hallturn", function(arg0, arg1, arg2)
{
	global.second_dia[17] = 1;
});
...
scribble_typists_add_event("edendance", function(arg0, arg1, arg2)
{
	obj_recordplayer.edendance = true;
});
...
scribble_typists_add_event("post1", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.post1 = true;
});
scribble_typists_add_event("post2", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.post2 = true;
});
scribble_typists_add_event("post3", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.post3 = true;
});
scribble_typists_add_event("post4", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.post4 = true;
});
...
scribble_typists_add_event("edenlight1", function(arg0, arg1, arg2)
{
	obj_eden_cry.edenlight1 = true;
});
scribble_typists_add_event("edenlight2", function(arg0, arg1, arg2)
{
	obj_eden_cry.edenlight2 = true;
});
scribble_typists_add_event("edenlight3", function(arg0, arg1, arg2)
{
	obj_eden_cry.edenlight3 = true;
});
...
scribble_typists_add_event("living1", function(arg0, arg1, arg2)
{
	obj_oliveeden_living.living1 = true;
});
scribble_typists_add_event("ebott1", function(arg0, arg1, arg2)
{
	obj_ebott_overlook.ebott1 = true;
});
scribble_typists_add_event("ebott2", function(arg0, arg1, arg2)
{
	obj_ebott_overlook.ebott2 = true;
});
...
scribble_typists_add_event("credits", function(arg0, arg1, arg2)
{
	obj_bench_ff_control.credits = true;
});
scribble_typists_add_event("forestfade", function(arg0, arg1, arg2)
{
	audio_sound_gain(snd_forest, 0, 4000);
});
scribble_typists_add_event("reset", function(arg0, arg1, arg2)
{
	obj_end_credits.reset = true;
});
scribble_typists_add_event("eulogy", function(arg0, arg1, arg2)
{
	audio_play_sound(mus_eulogy, 1, true);
	audio_sound_loop_end(mus_eulogy, 52.4);
});
scribble_typists_add_event("playguitar", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.playguitar = true;
});
...
scribble_typists_add_event("nightfade", function(arg0, arg1, arg2)
{
	audio_sound_gain(mus_school_night, 0, 500);
});
scribble_typists_add_event("helmetunlock3", function(arg0, arg1, arg2)
{
	global.helmet_unlock3 = true;
...
{
	if (instance_exists(obj_kaitlyn_warp_school))
		obj_kaitlyn_warp_school.warptoeden = true;
	if (instance_exists(obj_kaitlyn_warp_office))
		obj_kaitlyn_warp_office.warptoeden = true;
	global.slowfade = true;
});
...
scribble_typists_add_event("pageactivate", function(arg0, arg1, arg2)
{
	obj_chai_forest_bench.page_activate = true;
});
...
scribble_typists_add_event("reskip", function(arg0, arg1, arg2)
{
	unskip = false;
});
